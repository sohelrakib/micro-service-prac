...
class DirectExchangeConsumerApp1 extends Command
{
    /**
     * The name and signature of the console command.
     * php artisan make:command DirectExchangeConsumerApp1
     * php artisan rabbitmq:direct-exchange-consumer-app1
     * 
     * @var string
     */
    protected $signature = 'rabbitmq:direct-exchange-consumer-app1';
     ...
     * @var string
     */
    protected $description = 'Consume messages from direct exchange (App1)';
    ...
    public function handle()
    {
        ...
        // --------------------------------------------------------
        // STEP 4: Declare App1 queue
        // --------------------------------------------------------
        $channel->queue_declare(
            'product_direct_queue_app1',
            false,
            true,
            false,
            false
        ...
        // --------------------------------------------------------
        $channel->queue_bind(
            'product_direct_queue_app1', // queue
        ...
        $this->info('App1 waiting for messages...');
        ...
        $channel->basic_consume(
            ...
            'product_direct_queue_app1', // queue name
    ...
    public function handleMessage(AMQPMessage $message): void
    {
        ...
        $this->info('App1 received message');
